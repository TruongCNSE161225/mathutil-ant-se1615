 ...
 */
package com.truongcn.mathutil.main;
...
public class Main {
    ...
    //Kiểm thử xem hàm getF() có chửi hay ko nếu đưa n cả nhóm
    ...
    //Ta phải giả lập cách xài của user/của ai đó khác
    ...
    public static void testFactorialGivenRightArgumentReturnsWell() {
        ...
        //Test case #1: Tình huống sài hàm số 1
        //              Test getF() with n = 0;
        //Expected value: 1
        ...
        //Expected value: 1
        //Vietsub: kiểm tra tình huống sài hàm tính 1! coi có
        //trả về 1 hay hem?
        n = 1;
        expectedValue = 1;
        ...
        //Expected value: 2
        //Vietsub: kiểm tra tình huống sài hàm tính 2! coi có
        //trả về 2 hay hem?
